...
QtObject {
  ...
  property FontLoader digitalFont: FontLoader {
    id: digitalFont
    source: "qrc:/res/fonts/digital_cyr.otf"
  }

  readonly property int initialTick: 16
  readonly property int tick: 24
  ...
  readonly property int delay_200: 200
  readonly property int delay_500: 500
  readonly property int delay_2000: 2000
